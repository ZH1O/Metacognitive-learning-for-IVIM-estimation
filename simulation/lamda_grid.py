...
plt.xticks(fontsize=50)
plt.yticks(fontsize=50)
plt.xlabel('$\it{λ}$',fontsize=50,font={"family":'Times New Roman'})
plt.ylabel(ivimname[2],fontsize=50,font={"family":'Times New Roman'})
plt.ylim(2,30)
plt.plot(lamda_list,diff_data[:,3],linewidth=8)

plt.subplots_adjust(wspace =0.3, hspace =0.1)
plt.savefig(r'C:\Users\Administrator\Desktop\code\Unity_Brain\MC_PINN\fig\lamda.jpg' , dpi = 500)
...
plt.xticks([0.45,0.55],fontsize=150)
plt.yticks(fontsize=150)
plt.yticks([0.05,0.24],fontsize=150)
plt.xlim(0.44,0.55)
plt.ylim(0.01,0.27)
plt.yticks(fontsize=150)
...
plt.xticks([0.45,0.55],fontsize=150)
plt.yticks([4.5,6.5],fontsize=150)
plt.xlim(0.44,0.55)
plt.ylim(4.1,6.9)
plt.yticks(fontsize=150)
plt.subplots_adjust(wspace =0.6, hspace =0.1)

plt.savefig(r'C:\Users\Administrator\Desktop\code\Unity_Brain\MC_PINN\fig\lamdamini.jpg', dpi = 500)
plt.show()
