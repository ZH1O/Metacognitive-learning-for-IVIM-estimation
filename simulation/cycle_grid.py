...
plt.xticks(cycle_num_list,fontsize=80)
plt.yticks(fontsize=80)
plt.xlabel('K',fontsize=100,font={"family":'Times New Roman'})
...
plt.xticks(cycle_num_list,fontsize=80)
plt.yticks(fontsize=80)
plt.xlabel('K',fontsize=10,font={"family":'Times New Roman'})
plt.ylabel(ivimname[2],fontsize=10,font={"family":'Times New Roman'})
plt.subplots_adjust(wspace =0.4, hspace =0.)
plt.ylim(5.5,5.9)

plt.savefig(r'C:\Users\Administrator\Desktop\code\Unity_Brain\MC_PINN\fig\cycle_num.jpg', dpi = 500, bbox_inches='tight')
plt.show()
