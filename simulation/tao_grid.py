...
plt.xlabel('$\mathrm{τ\it{_{D_{p}}}}$',fontsize=100)
plt.ylabel('$\mathrm{\it{{D_{t}}}}$ RMSE [$\mathrm{{10^{-3}}}$ $\mathrm{\it{{mm^{2}}}}$/s]',fontsize=100)
plt.xscale("log")
...
plt.yticks(fontsize=80)
plt.xlabel('$\mathrm{τ\it{_{D_{p}}}}$',fontsize=100)
plt.ylabel('$\mathrm{\it{{D_{p}}}}$ RMSE [$\mathrm{{10^{-3}}}$ $\mathrm{\it{{mm^{2}}}}$/s]',fontsize=100)
plt.xscale("log")
...
plt.yticks(fontsize=80)
plt.xlabel('$\mathrm{τ\it{_{D_{p}}}}$',fontsize=100)
plt.ylabel('$\mathrm{\it{{F_{p}}}}$ RMSE [%]',fontsize=100)
plt.xscale("log")

plt.subplots_adjust(wspace =0.4, hspace =0.)
plt.savefig(r'C:\Users\Administrator\Desktop\code\Unity_Brain\MC_PINN\fig\t.jpg', dpi = 500,bbox_inches='tight')
plt.show()
...
plt.xticks([12,48],fontsize=200)
plt.yticks([0.10,0.18],fontsize=200)
plt.xlim(8,52)
plt.ylim(0.09,0.19)
